<li class="treeview">
	...
	<ul class="treeview-menu">
		<li><a href="<?php echo base_url('bimbingan/koordinator'); ?>"><i class="fa fa-circle-o"></i> Bimbingan (Koor)</a></li>
		<li><a href="<?php echo base_url('sidang/koordinator'); ?>"><i class="fa fa-circle-o"></i> Sidang (Koor)</a>
		</li>
		<li><a href="<?php echo base_url('bimbingan/dosen'); ?>"><i class="fa fa-circle-o"></i> Bimbingan</a></li>

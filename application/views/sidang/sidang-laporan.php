  						...
  						<?php
							...
							foreach ($sidang as $sdg) {
  							...
  							<tr>
  								...
  								<td>
  									<a href="<?php echo base_url('/uploads/sidang/' . $sdg->upload_berita_acara); ?>" target='_blank' class="btn btn-info  btn-flat">View</a>
  									<a href="<?php echo base_url('/sidang/download/' . $sdg->upload_berita_acara); ?>" class="btn btn-primary  btn-flat">Download</a>
  								</td>
  							</tr>
  						<?php } ?>
  					</tbody>

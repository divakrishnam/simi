            ...
            <div class="box-body">
              ...
              ?>
                ...
                <td><?php echo $no++ ?></td>
                  ...
                  <td><input type="submit"   <?php if($bim->status_bimbingan == null){echo 'class="btn btn-warning" value="Disapprove"';}else{echo 'class="btn btn-success" value="Approve"';}; ?> name="persetujuan"></td>
                  </form>
                </tr>
                  <?php } ?>
                </tbody>

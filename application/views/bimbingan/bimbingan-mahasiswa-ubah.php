  ...
  <div class="content-wrapper">
      ...
      <section class="content">
          ...
          <div class="box box-default">
              ...
              <!-- /.box-header -->
              <form action="<?php echo base_url('bimbingan/update_act_bimbingan_mahasiswa/' . $bimb->kd_detail_bimbingan . '/' . $bimb->kd_bimbingan . '/' . $bimb->npm); ?>" method="post">
                  <div class="box-body">
                      <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="hidden" value="<?php echo $bimb->kd_bimbingan; ?>" name="kd_bimbingan" required>
                              </div>

                              <div class="form-group">
                                  <label>Tanggal Bimbingan</label>
                                  <input type="text" value="<?php $date = date_create($bimb->tanggal_bimbingan);
                                                            echo date_format($date, "m/d/Y"); ?>" class="form-control pull-right" id="datepicker" name="tanggal_bimbingan" required>
                              </div>
                          </div>
                          <!-- /.col -->
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <textarea class="form-control" rows="4" placeholder="Enter ..." name="topik_bimbingan" required><?php echo $bimb->topik_bimbingan; ?></textarea>
                              </div>
                          </div>
                          <!-- /.col -->
                      </div>
